...
<c:forEach var="image" items="${list}">
        <div class="paper"> 
            <div class="paper-holder"> 
                <a><img width="190" src="${image.src}"/></a> 
            </div> 
            <p class="paper-description">${image.description}</p> 
            <div class="paper-content"> 
                <a class="paper-link" href="#"><img src='<c:out value="${image.paperLink}"/>' /></a> 
                <p class="paper-text">${image.paperText}</p> 
            </div> 
        </div>
</c:forEach>
